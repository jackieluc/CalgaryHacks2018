const routes = {
  ...
  '/charts': 'Charts',
  '/dashboard': 'Dashboard',
  '/status-history/temperature': 'Temperature History',
  '/status-history/air-quality': 'Air Quality History',
  '/status-history/motion': 'Motion History',
  '/status-history/humidity': 'Humidity History',
  '/icons': 'Icons',
  '/icons/flags': 'Flags',
